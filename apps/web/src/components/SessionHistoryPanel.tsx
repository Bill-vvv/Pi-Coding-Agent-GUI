...
export function SessionHistoryPanel({ project, sessions, runtimes, connection, pendingRestoreId, onClose, onResumeSession, onSelectRuntime }: SessionHistoryPanelProps) {
  ...
  const visibleSessions = useMemo(() => {
    ...
    return sessions
      .filter((session) => session.projectId === project.id && session.title)
  ...
  return (
    <section className="session-history-panel" aria-label={`${project.name} 的历史对话`}>
